...
//# sourceMappingURL=/__opal_source_maps__/user.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
...
//# sourceMappingURL=/__opal_source_maps__/foo.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var $a, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, user = nil;

  $opal.add_stubs(['$puts', '$bar', '$new', '$admin?']);
  ;
  ;
  ;
  self.$puts((($a = $scope.Foo) == null ? $opal.cm('Foo') : $a).$new().$bar());
  user = (($a = $scope.User) == null ? $opal.cm('User') : $a).$new("Bob");
  self.$puts(user);
  self.$puts(user['$admin?']());
